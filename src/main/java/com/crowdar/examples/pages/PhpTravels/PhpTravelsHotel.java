...
public class PhpTravelsHotel extends PhpHomePage {
    ...
    private final String FORM_TOUR_CSS = "body > div.body-inner > div.main-wrapper.scrollspy-action > div:nth-child(6)";
    ...
    public void selectTour(){
        WebElement tour = driver.findElement(By.cssSelector(FORM_TOUR_CSS));
        js.executeScript("arguments[0].scrollIntoView();", tour);
